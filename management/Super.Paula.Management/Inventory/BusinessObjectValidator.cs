...
namespace Super.Paula.Management.Inventory
{
    ...
    {
        public static (Func<bool, bool>, FormattableString) BusinessObjectHasValue(string businessObject)
            => (_ => !string.IsNullOrWhiteSpace(businessObject),
                    $"Business object must have a value");

        public static (Func<bool, bool>, FormattableString) BusinessObjectHasKebabCase(string businessObject)
            => (x => x && KebabCaseValidator.IsValid(businessObject),
                    $"Business object '{businessObject}' must be in kebab case");

        public static (Func<bool, bool>, FormattableString) BusinessObjectExists(string businessObject, IQueryable<BusinessObject> businessObjects)
            => (x => x && businessObjects.FirstOrDefault(x => x.UniqueName == businessObject) != null,
                    $"Business object '{businessObject}' does not exist");

        public static (Func<bool, bool>, FormattableString) UniqueNameHasValue(BusinessObject businessObject)
            => (_ => !string.IsNullOrWhiteSpace(businessObject.UniqueName),
                    $"Unique name of business object must have a value");

        public static (Func<bool, bool>, FormattableString) UniqueNameHasKebabCase(BusinessObject businessObject)
        ...
        public static (Func<bool, bool>, FormattableString) UniqueNameIsUnqiue(BusinessObject businessObject, IQueryable<BusinessObject> businessObjects)
        ...
        public static (Func<bool, bool>, FormattableString) UniqueNameExists(BusinessObject businessObject, IQueryable<BusinessObject> businessObjects)
            => (x => x && businessObjects.FirstOrDefault(x => x.UniqueName == businessObject.UniqueName) != null,
                    $"Unique name '{businessObject.UniqueName}' of business object does not exist");

        public static (Func<bool, bool>, FormattableString) DisplayNameHasValue(BusinessObject businessObject)
        ...
        public static (Func<bool, bool>, FormattableString) InspectorIsNotNull(BusinessObject businessObject)
            => (_ => businessObject.Inspector != null,
                    $"Inspector of business object '{businessObject.UniqueName}' can not be null");

        public static (Func<bool, bool>, FormattableString) InspectorHasKebabCase(BusinessObject businessObject)
